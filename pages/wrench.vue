<template>
	<div class="w-full m-auto relative bg-[#1A1A1A]">
		...
		<ServicePageHeader :quotient-arr="wrenchQuotient" :description />

		<ServiceExamples :images="wrenchImages" />

		<!-- price -->
		<section id="price" class="mt-[90px] pb-[80px] w-fit m-auto">
			<ServicePriceGroup :services-price-group="wrenchMenu" />
		</section>
	</div>
</template>
...
import { wrenchImages } from '~/widgets/service/config/serviceExampleImages'
