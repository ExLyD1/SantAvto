						...
						>
							...
							<div class="contactInfo flex flex-col mt-[95px]">
								<p>
									...
									послуги для вашого авто. Ми зв'яжемося з
								...
								<div class="privacySection space-y-4">
									...
									>
										<div
											...
											class="checkboxField w-[30px] h-[24px] rounded-full flex items-center justify-center cursor-pointer border border-[#232323] select-none"
										>
											<NuxtImg
...
const quotientArr = ['Оформлення', 'запиту на', 'рекламу']
...
function submitForm() {
	...
	const templateParams = {
		...
		message:
			form.phoneNumber +
			'\t Пишу вам на рахунок пропозиції реклами. Чекаю на дзвінок!',
